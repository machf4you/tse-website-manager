...
| v1.27-deploy-auth | `v1.27-global-deployment-indicator-auth-fix` | `[AUTO]` | 17-08-2026 12:53 | Pass credentials: 'same-origin' in GlobalDeploymentIndicator to authenticate version.json polls over Nginx Basic Auth (V1.27). | **Current** |
