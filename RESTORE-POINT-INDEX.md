...
| v1.30-token-overwrite | `v1.30-fix-magento-token-overwrite` | `[AUTO]` | 18-08-2026 07:49 | Fix raw password overwrite of fresh Bearer token in AddWebsiteDialog and server/index.js (V1.30). | **Current** |
