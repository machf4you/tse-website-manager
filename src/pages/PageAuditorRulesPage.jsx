...
export default function PageAuditorRulesPage() {
  const auditRules = [
    ...
    },
    {
      ...
      weight: '6%',
      purpose: 'Verifies that images have descriptive alt attributes for accessibility and image SEO.',
      dataExtracted: 'Array of images with their alt text strings (extracted.images).',
      matchingLogic: 'Verify that every image on the page has non-empty, descriptive alt text.',
      scoringContribution: 'Part of 6 Points (Images area weight).',
      passCriteria: 'All relevant images have meaningful alt text.',
      failCriteria: 'One or more relevant images are missing meaningful alt text.',
      recommendedAction: 'Add meaningful alt tags to [N] images missing them.',
      passExample: 'Images: 10 total images, 10 have descriptive alt text (0 missing).',
      failExample: 'Images: 10 total images, 4 missing alt text. (Fail: Add meaningful alt tags to 4 images missing them)',
    },
  ]
