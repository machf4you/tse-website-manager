...
|---|---|---|---|---|---|
| v2.12-app-progress-persistent | `v2.12-stable-app-progress-persistent` | `e5a5bdf` | 07-09-2026 08:20 | Permanent server-backed App Progress board, 7 applications registered, SQLite persistence & history tracking. | **Current** |
