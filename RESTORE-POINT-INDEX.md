...
| v1.30-hf4you-excl | `v1.30-hf4you-exclusion-rules` | `[AUTO]` | 18-08-2026 08:37 | Extended HF4You page exclusion rules for utility/policy CMS pages in packageExtractor and server/index.js (V1.30). | **Current** |
