...
| v1.26-magento | `v1.26-hf4you-magento-category-import` | `[AUTO]` | 17-08-2026 12:48 | Magento Admin Token authentication flow and category tree structure import for HF4You (V1.26). | **Current** |
