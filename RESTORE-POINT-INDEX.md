...
| v1.28-w2-sync | `v1.28-w2-platform-aware-sync-button` | `[AUTO]` | 17-08-2026 13:09 | Make W2 sync button platform-aware (Sync from Magento/WordPress/Other) and remove W2 audit buttons (V1.28). | **Current** |
