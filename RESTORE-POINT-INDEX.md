...
| v1.30-remove-w3-sync | `v1.30-remove-w3-sync-button` | `[AUTO]` | 18-08-2026 07:56 | Remove obsolete Sync from WordPress button from W3 Page Management top-right header (V1.30). | **Current** |
