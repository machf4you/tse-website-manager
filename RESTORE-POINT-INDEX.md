...
|---|---|---|---|---|---|
| v1.50-w4-package-source-of-truth-fix | `v1.50-w4-synced-package-data-as-authoritative-actuals-source-of-truth-fix` | `[AUTO]` | 28-08-2026 08:46 | Synced WordPress package data as authoritative source of truth for W4 ACTUAL (LIVE) fields. | **Current** |
