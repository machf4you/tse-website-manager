...
|---|---|---|---|---|---|
| v2.12-stable-before-realtime | `v2.12-stable-before-website-manager-realtime` | `[AUTO]` | 10-09-2026 09:50 | Confirmed stable baseline restore point of TSE Website Manager prior to introducing Supabase Realtime Broadcast multi-user synchronization. Authoritative SQLite/Express backend, WordPress Exporter & REST API sync/push, Magento 2 sync/auth, W3 page classification & natural sorting, and W4 page auditor all verified operational. | **Current** |
