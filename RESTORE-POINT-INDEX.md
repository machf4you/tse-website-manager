...
| v1.30-server-hydration | `v1.30-server-state-hydration-fix` | `[AUTO]` | 17-08-2026 17:44 | Authoritative SQLite database hydration for active managedSite in WebsitesDashboard (V1.30). | **Current** |
