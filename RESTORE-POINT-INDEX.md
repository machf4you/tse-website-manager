...
| v1.30-hf4you-target | `v1.30-hf4you-target-phrases` | `[AUTO]` | 18-08-2026 08:18 | Auto-configure 50 commercial HF4You Magento target phrases while leaving 9 filter pages untouched in SQLite (V1.30). | **Current** |
