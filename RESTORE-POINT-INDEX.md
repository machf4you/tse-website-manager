...
| v1.2 | `v1.2-websites-dashboard` | `9f42b7e` | 2026-07-30 | Milestone 2 dashboard with sidebar, summary cards and website grid. Superseded when dashboard was cleared for master tile approach. | Superseded |
| v1.1 | `v1.1-foundation-master-tile` | `61c1e83` | 2026-08-07 | Project Foundation complete and approved. Automatic deployment verified via TSE Deployer. Master Website Tile built and approved. Ready for next milestone. | **Current** |
