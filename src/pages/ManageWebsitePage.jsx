  ...
  const exportedPages = rawExportedPages.map(page => {
    ...
    if (override) {
      return {
        ...
        metaTitle: override.metaTitle || finalProposedTitle,
        proposedMetaDescription: override.proposedMetaDescription || override.metaDescription || page.proposedMetaDescription || page.metaDescription || '',
        metaDescription: override.metaDescription || override.proposedMetaDescription || page.metaDescription || page.proposedMetaDescription || '',
        proposedH1: override.proposedH1 || override.h1 || page.proposedH1 || page.h1 || '',
        h1: override.h1 || override.proposedH1 || page.h1 || page.proposedH1 || '',
        actualMetaTitle: override.actualMetaTitle || override.pushedActualMetaTitle || page.actualMetaTitle || '',
        actualMetaDescription: override.actualMetaDescription || override.pushedActualMetaDescription || page.actualMetaDescription || '',
        actualH1: override.actualH1 || override.pushedActualH1 || page.actualH1 || '',
        pushedActualMetaTitle: override.pushedActualMetaTitle || '',
        pushedActualMetaDescription: override.pushedActualMetaDescription || '',
        pushedActualH1: override.pushedActualH1 || '',
    ...
    return {
      ...
      metaTitle: page.metaTitle || rawPageTitle,
      proposedMetaDescription: page.proposedMetaDescription || page.metaDescription || '',
      metaDescription: page.metaDescription || page.proposedMetaDescription || '',
      proposedH1: page.proposedH1 || page.h1 || '',
      h1: page.h1 || page.proposedH1 || '',
      actualMetaTitle: page.actualMetaTitle || '',
      actualMetaDescription: page.actualMetaDescription || '',
      actualH1: page.actualH1 || '',
      target: targetPhraseStr,
      targetPhrase: targetPhraseStr,
      type: pageType,
      seoPageType: pageType,
