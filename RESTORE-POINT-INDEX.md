...
|---|---|---|---|---|---|
| v2.20-stable | `v2.20-stable-website-manager-realtime` | `[AUTO]` | 10-09-2026 10:00 | Real-Time Multi-User Synchronization operational in TSE Website Manager: Supabase Realtime Broadcast layer (<50ms pub/sub) synchronizes active administrative sessions (Mac & Deb) automatically without browser reload across website tiles, page configurations (target phrases, page types, priority), package syncs, page audits, and internal linking recommendations. Self-echo immunity, loop prevention, unmount cleanup, and SQLite/Express single-source-of-truth persistence verified live. | **Current** |
