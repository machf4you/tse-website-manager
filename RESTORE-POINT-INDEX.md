...
| v1.30-pass-toggle | `v1.30-add-website-dialog-password-toggle` | `[AUTO]` | 17-08-2026 14:55 | Add Show/Hide visibility toggle button beside API Password/Token field in AddWebsiteDialog (V1.30). | **Current** |
